...
def get_relative_coords_table(
    ...
    # TD: pretrained window size and pretrained anchor window size is only used here.
    # TD: Investigate whether it is really important to use this setting when finetuning large window size
    # TD: based on pretrained weights with small window size.
