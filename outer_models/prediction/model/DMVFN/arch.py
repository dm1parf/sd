...
class MVFB(nn.Module):
    def __init__(self, in_planes, num_feature, scale: float):
    ...
    def forward(self, x, flow):
        ...
        flow = F.interpolate(flow, scale_factor=1. / self.scale, mode="bilinear", align_corners=False) * 1. / self.scale
        ...
        x2 = F.interpolate(x2, scale_factor=self.scale * 2, mode="bilinear", align_corners=False)
