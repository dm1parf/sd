...
class BonchSDInpPipeline(StableDiffusionInpaintPipeline):
    ...
    def bonch_encode(self,
        ...
        return (latents, image_latents, masked_image_latents, encoded_vae_image, mask, noise)
    
    def bonch_decode(self,
        # prompt: Union[str, List[str]] = None,
        image: Union[torch.FloatTensor, PIL.Image.Image] = None,
        # mask_image: Union[torch.FloatTensor, PIL.Image.Image] = None,
        # height: Optional[int] = None,
        ...
        bonch_tuple = None):
            if bonch_tuple is not None:
                latents, image_latents, masked_image_latents, encoded_vae_image, mask, noise = bonch_tuple
