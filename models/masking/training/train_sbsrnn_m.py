...
from models.masking.simple_mask_nn import SBSRNN_M
from models.masking.masker import MaskMaster
from models.masking.training.latent_dataset import LatentDataset

arguments = argparse.ArgumentParser(prog="Обучение ПНСВБП-М (SBSRNN-M)",
...
test_rate = 0.2
weights_saver = "models/masking/weights/sbsrnn_m_{}_{}_ep{}"
