...
from dependence.util import load_model_from_config
# Можно и переделать под аргументы, но смысл?
# Здесь лишь показано, как создавать


base = "1"
from_img = r"dependence\img_test\{}.png".format(base)
to_img = r"dependence\img_test\{}_.png".format(base)

model_type = "kl-f16"  # kl-f32
config_file = r"dependence\config\{}.yaml".format(model_type)
ckpt_file = r"dependence\ckpt\{}.ckpt".format(model_type)
