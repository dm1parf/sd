...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="./dependence/config/vq-f16.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="./dependence/ckpt/vq-f16.ckpt",
    ...
    base = "1"
    test_image = r"./dependence/img_test/{}.png".format(base)
    # Можно если что сохранить промежуточный с убранным альфа-каналом
    # pre_image = r"test_magic\apple2.png"
    latent_image = r"./dependence/img_test{}l.png".format(base)
    end_image = r"./dependence/img_test{}_.png".format(base)
    jpeg_image = r"./dependence/img_test{}.jpg".format(base)
